...
// Client-side shim: return embedded technologies synchronously (same cast as simulationEngine)
function getTechnologies(): TechnologyDatabase { return TECHNOLOGIES as unknown as TechnologyDatabase; }
